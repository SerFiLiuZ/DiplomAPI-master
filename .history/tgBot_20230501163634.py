...
def checkPasswordOrg(p):
    ...
    if result > 0:
        print("Пароль организации с таким паролем у")
        return True
    else:
        return False
...
def add_worker_in_db(passwordCorp, FIO, phoneNumber, chatID, userName, date):
    try:
        ...
        sql = "INSERT INTO taskdb.аpplications (passwordCorp, FIO, phoneNumber, chatID, userName, dataApplication) VALUES (%s, %s, %s, %s, %s, %s)"
